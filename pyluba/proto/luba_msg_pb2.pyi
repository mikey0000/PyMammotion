...
class LubaMsg(_message.Message):
    __slots__ = ["driver", "msgattr", "msgtype", "nav", "net", "null", "ota", "rcver", "sender", "seqs", "subtype", "sys", "timestamp", "version"]
    ...
    driver: _mctrl_driver_pb2.MctrlDriver
    msgattr: MsgAttr
    msgtype: MsgCmdType
    nav: _mctrl_nav_pb2.MctlNav
    net: _dev_net_pb2.DevNet
    null: MsgNull
    ota: _mctrl_ota_pb2.MctrlOta
    rcver: MsgDevice
    sender: MsgDevice
    seqs: int
    subtype: int
    ...
    timestamp: int
    version: int
    def __init__(self, msgtype: _Optional[_Union[MsgCmdType, str]] = ..., sender: _Optional[_Union[MsgDevice, str]] = ..., rcver: _Optional[_Union[MsgDevice, str]] = ..., msgattr: _Optional[_Union[MsgAttr, str]] = ..., seqs: _Optional[int] = ..., version: _Optional[int] = ..., subtype: _Optional[int] = ..., timestamp: _Optional[int] = ..., net: _Optional[_Union[_dev_net_pb2.DevNet, _Mapping]] = ..., sys: _Optional[_Union[_mctrl_sys_pb2.MctlSys, _Mapping]] = ..., nav: _Optional[_Union[_mctrl_nav_pb2.MctlNav, _Mapping]] = ..., driver: _Optional[_Union[_mctrl_driver_pb2.MctrlDriver, _Mapping]] = ..., ota: _Optional[_Union[_mctrl_ota_pb2.MctrlOta, _Mapping]] = ..., null: _Optional[_Union[MsgNull, _Mapping]] = ...) -> None: ...
