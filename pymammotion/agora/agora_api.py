...
async def main() -> None:
    ...
    # Example parameters
    # mammotion_http = MammotionHTTP('michael@jumblesoft.co.nz', '2i6FyCfMplCt')
    # mammotion_http.login_info = LoginResponseData.from_dict(json.loads('{"access_token":"eyJraWQiOiIxYWQ0NzI1Ni1hMGFjLTQ3MDEtOTVhYS0xOTFkM2FiYjZhOTQiLCJhbGciOiJSUzI1NiJ9..RgJE_3wqIB8Kytro_1ijPx6Z0A6J9gUugmkUUDHrSrGdTv3efzsGKB5Wh0WpCG_EMf32Koq0I9F5G74j5BN8U5-U0I4jrRdr41-1fTeJuo20-UaNwz51CNh607KtOSZ-7u0h97x1FwnATG-goLTzwLmXBDhPad4SIrGazbC9GNIzISm-zZDUf_t_Lm2etxlN-I2s_bERtFQ4Tt3n5GEJJUQmobt8TmpXi8JqVHYuYGrxKBV-YYkHujiW7xs0qqylcBon13bKWXoAG2AAkt1t4qxN_FxYSq7ixFV16jNN2waf7ZIPcXVJSoR-3tP_bos63ZDtu4683YxnGnU8ufjXUg","token_type":"Bearer","refresh_token":"eyJraWQiOiIxYWQ0NzI1Ni1hMGFjLTQ3MDEtOTVhYS0xOTFkM2FiYjZhOTQiLCJhbGciOiJSUzI1NiJ9.eyJzdWIiOiI4MjA4NTEzNTY4MTMyMzAwODAiLCJhdWQiOiJHeGViZ1N0OHNpNnBLcVIiLCJlbmRwb2ludCI6ImFwIiwiZ3JhbnRfdHlwZSI6InBhc3N3b3JkIiwiZXhwIjoxNzY2ODYxNjQ2LCJhdXRoVHlwZSI6IjAiLCJpYXQiOjE3NjI5NzM2NDYsImp0aSI6IjMwMjQ3OGU5LTY4ZjYtNDlhNS1hMmYxLWZmMGMwYWE5Yzg4MiJ9.Q0ED8vOqGChI5g2PSQANNWgLfO0zEvCf6rXVtqK5sAimoSwAypC_EUYu-hLxGiJqMtdc8w9PK1BsNU36jb1_BcC68g4tpK09ILmt--A8nu9mORLLLu7DvwlGdECpmaV2YVsm6R1r1Ww8Lf4by1WDVDMQZDJf4Us6bRz4mutMuL2ro6zMjxRdASMFKlruV5WhckmULUmdmgH5-XeVY_aUeqHoXlGbcbXHj1kw0zFMIsH1ekj9zV6absyITiNftf5WBiti_9H6O_UUxRF6oyZNlofC_SYSuQHecmpZewj9SQ4wLKANtSsAKb7fkPgxN2NtMbaUQ1Tsh4gjwJ5VwLw9ow","expires_in":21999, "authorization_code":"MgV3ZUBIQ7e9zHief7PFp0l36VoUGTWSo1kBk9uHV7budsJELdIltH_Yz2F0G7Tls29JjFyj2SDHzyVq_VWeXZmb24y-DsyB1-BQghJkuSUqpkCdDCBwa_1qNczvQ3yB.ap" ,"userInformation":{"areaCode":"NZL","domainAbbreviation":"NZ","userId":"420400518649610240","userAccount":"21231058","authType":"0","email":"michael@jumblesoft.co.nz"},"jti":null,"grant_type":null,"scope":null}'))
    ...
    channel_name = "VIfnsgIQCmHqn4IXXWkQ000000"
    # user_id = stream.data.uid
    # app_id = stream.data.appid
    # token = stream.data.token
    user_id = 81260392
    app_id = "5bcfed01952d4f2eb306c98b8908da93"
    token = "007eJxTYPhxc8+cuOl8L/7p5R6T9M5aJvrzxBwTbbcLgm4+e/52r1qnwGCalJyWmmJgaGlqlGKSZpSaZGxglmxpkWRhaWCRkmhp7PtQJFOAj4Hhvs7vT4wMEAjiSzGEeablFad7BjrnehTmmXhGRIRnBxqAAQeDhaGRmYGxpREATXspCg=="
